...
from wmsAdapterV2.models import TdaWmsDpn, TdaWmsEpn
...
def read_production_orders(request, db_name):
        ...
        try:
            ...
            sort, params = get_sort(TdaWmsEpn, params)
            fields = validate_fields(fields, TdaWmsEpn)
            include, params = get_include_filter(TdaWmsDpn, params)
            query, params = filter_by_field(TdaWmsEpn, query, params)
            query_detail, params = validate_field_model_and_detail(query, params)
            query_detail, params = filter_by_field(TdaWmsDpn, query_detail, params)
