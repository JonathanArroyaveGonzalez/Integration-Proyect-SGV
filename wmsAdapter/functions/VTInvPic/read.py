...
from wmsAdapter.models import VTInvPic

def read_VTInvPic(request, db_name):
        ...
        fields = [field.name for field in VTInvPic._meta.get_fields()]
        ...
        try: 
            ...
            response = VTInvPic.objects.using(db_name).filter(query, fecha__range=[fecha_inicial, fecha_final])[:500]
            return response
