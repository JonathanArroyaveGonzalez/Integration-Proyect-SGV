...
from wmsAdapter.models import VTDetallePrepack

def read_vtggtdprepack(request, db_name):
        ...
        fields = [field.name for field in VTDetallePrepack._meta.get_fields()]
        ...
        try: 
            ...
            response = VTDetallePrepack.objects.using(db_name).filter(query, fecha__range=[fecha_inicial, fecha_final])[:500]
            return response
