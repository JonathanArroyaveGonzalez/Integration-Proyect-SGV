...
def create_relacion_seriales(request, db_name, request_data=None):
        ...
        try:    
            try:
                TdaWmsRelacionSeriales.objects.using(db_name).create(**final_fields)
