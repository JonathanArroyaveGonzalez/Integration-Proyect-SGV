...
class InternalAPIService:
    ...
    def extract_authorization(self, request_or_headers: Union[Dict, Any]) -> Optional[str]:
        """
        ...
        if isinstance(request_or_headers, dict):
            return request_or_headers.get('Authorization') or request_or_headers.get('authorization')
    ...
    def forward_request(
        ...
        **kwargs
        ...
        try:
            ...
            logger.error(f"Unexpected error calling internal API: {method} {url} - {str(e)}")
            raise
    
    def get(self, endpoint: str, original_request: Any = None, **kwargs) -> requests.Response:
        """Make GET request to internal API."""
        return self.forward_request('GET', endpoint, original_request, **kwargs)
    
    def post(self, endpoint: str, original_request: Any = None, **kwargs) -> requests.Response:
        """Make POST request to internal API."""
        return self.forward_request('POST', endpoint, original_request, **kwargs)
    
    def put(self, endpoint: str, original_request: Any = None, **kwargs) -> requests.Response:
        """Make PUT request to internal API."""
        return self.forward_request('PUT', endpoint, original_request, **kwargs)
    
    def patch(self, endpoint: str, original_request: Any = None, **kwargs) -> requests.Response:
        """Make PATCH request to internal API."""
        return self.forward_request('PATCH', endpoint, original_request, **kwargs)
    
    def delete(self, endpoint: str, original_request: Any = None, **kwargs) -> requests.Response:
...
def get_internal_api_service(base_url: Optional[str] = None) -> InternalAPIService:
    ...
    if _internal_api_service is None or (base_url and base_url != _internal_api_service.base_url):
