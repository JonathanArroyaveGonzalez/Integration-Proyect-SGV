...
from mercadolibre.utils.mappers.data_mapper import ProductMapper
    ...
    for item in meli_items:
        try:
            ...
            wms_product.update(
                {
                    ...
                    "controla_status_calidad": wms_product.get(
            ...
            if all(wms_product.get(field) for field in required_fields):
                ...
                print(
                    f"Producto omitido por campos obligatorios faltantes: {product_data.get('id', 'N/A')}"
                )
